  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-integral-estetica";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="CENTRO INTEGRAL ESTÉTICA VANESA LÓPEZ"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="centro-integral-estetica"
          data-primary-color="#a97b61"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="centro-integral-estetica";
